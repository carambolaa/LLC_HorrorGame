	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord10 = packedInput.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				...
				float2 uv_Noise_Texture = packedInput.ase_texcoord5.xy * _Noise_Texture_ST.xy + _Noise_Texture_ST.zw;
				float4 clampResult126 = clamp( ( ( ( 1.0 - ( simplePerlin2D7 * simplePerlin2D12 * tex2D( _Noise_Texture, uv_Noise_Texture ) ) ) + _Bias ) * _Scale ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float3 temp_output_67_0 = ( ( pow( clampResult126 , temp_cast_2 ).rgb * temp_output_2_0_g2 ) + appendResult7_g2 );
				float3 clampResult59 = clamp( temp_output_67_0 , float3( 0,0,0 ) , float3( 1,1,1 ) );
				...
				float2 texCoord38 = packedInput.ase_texcoord5.xy * temp_cast_5 + float2( 0,0 );
				...
				float2 uv_MainNormalMap = packedInput.ase_texcoord5.xy * _MainNormalMap_ST.xy + _MainNormalMap_ST.zw;
				...
				float clampResult127 = clamp( tex2DNode1.a , 0.0 , 1.0 );
				float3 clampResult125 = clamp( ( temp_output_67_0 * pow( clampResult127 , _TrasparencyPower ) ) , float3( 0,0,0 ) , float3( 1,1,1 ) );
				float3 clampResult25 = clamp( pow( clampResult125 , 6.0 ) , float3( 0,0,0 ) , float3( 1,0,0 ) );
				...
				surfaceDescription.Albedo = Out_Albedo82.rgb;
				surfaceDescription.Normal = Out_Normal84;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Out_Metalness81;
				...
				surfaceDescription.Smoothness = Out_Smoothness80;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_Noise1).xx;
				float2 texCoord10 = packedInput.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D7 = snoise( texCoord10 );
				float2 temp_cast_1 = (( _Noise1 * _Noise2 )).xx;
				float2 texCoord13 = packedInput.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				float simplePerlin2D12 = snoise( texCoord13 );
				float2 uv_Noise_Texture = packedInput.ase_texcoord.xy * _Noise_Texture_ST.xy + _Noise_Texture_ST.zw;
				float4 clampResult126 = clamp( ( ( ( 1.0 - ( simplePerlin2D7 * simplePerlin2D12 * tex2D( _Noise_Texture, uv_Noise_Texture ) ) ) + _Bias ) * _Scale ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_cast_2 = (( 3.0 * _Bias )).xxxx;
				float temp_output_2_0_g2 = _DriedBloodEffectLevel;
				float temp_output_3_0_g2 = ( 1.0 - temp_output_2_0_g2 );
				...
				float4 blendOpDest24 = ( _MainColorTintFadeA * tex2DNode1.r );
				float2 temp_cast_5 = (_DriedBloodEffect_Tiling).xx;
				float2 texCoord38 = packedInput.ase_texcoord.xy * temp_cast_5 + float2( 0,0 );
				float4 blendOpSrc36 = _DriedBloodColorGloss;
				float4 blendOpDest36 = tex2D( _DriedBlood_Curvature, texCoord38 );
				float3 temp_output_60_0 = ( clampResult59 * _DriedBloodEffectLevel );
				float4 lerpResult34 = lerp( ( saturate( (( blendOpDest24 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest24 ) * ( 1.0 - blendOpSrc24 ) ) : ( 2.0 * blendOpDest24 * blendOpSrc24 ) ) )) , (( blendOpDest36 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest36 ) * ( 1.0 - blendOpSrc36 ) ) : ( 2.0 * blendOpDest36 * blendOpSrc36 ) ) , float4( temp_output_60_0 , 0.0 ));
				...
				float2 uv_MainNormalMap = packedInput.ase_texcoord.xy * _MainNormalMap_ST.xy + _MainNormalMap_ST.zw;
				float3 lerpResult45 = lerp( UnpackNormalScale( tex2D( _MainNormalMap, uv_MainNormalMap ), 1.0f ) , UnpackNormalScale( tex2D( _DriedBlood_Normal, texCoord38 ), 1.0f ) , _DriedBloodEffectLevel);
				float3 lerpResult53 = lerp( float3(0,0,1) , lerpResult45 , _OverallNormalPower);
				float3 Out_Normal84 = lerpResult53;
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_cast_0 = (_Noise1).xx;
				float2 texCoord10 = packedInput.ase_texcoord1.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D7 = snoise( texCoord10 );
				float2 temp_cast_1 = (( _Noise1 * _Noise2 )).xx;
				float2 texCoord13 = packedInput.ase_texcoord1.xy * temp_cast_1 + float2( 0,0 );
				float simplePerlin2D12 = snoise( texCoord13 );
				float2 uv_Noise_Texture = packedInput.ase_texcoord1.xy * _Noise_Texture_ST.xy + _Noise_Texture_ST.zw;
				float4 clampResult126 = clamp( ( ( ( 1.0 - ( simplePerlin2D7 * simplePerlin2D12 * tex2D( _Noise_Texture, uv_Noise_Texture ) ) ) + _Bias ) * _Scale ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_cast_2 = (( 3.0 * _Bias )).xxxx;
				float temp_output_2_0_g2 = _DriedBloodEffectLevel;
				float temp_output_3_0_g2 = ( 1.0 - temp_output_2_0_g2 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_MainNormalMap = packedInput.ase_texcoord3.xy * _MainNormalMap_ST.xy + _MainNormalMap_ST.zw;
				float2 temp_cast_0 = (_DriedBloodEffect_Tiling).xx;
				float2 texCoord38 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float3 lerpResult45 = lerp( UnpackNormalScale( tex2D( _MainNormalMap, uv_MainNormalMap ), 1.0f ) , UnpackNormalScale( tex2D( _DriedBlood_Normal, texCoord38 ), 1.0f ) , _DriedBloodEffectLevel);
				float3 lerpResult53 = lerp( float3(0,0,1) , lerpResult45 , _OverallNormalPower);
				float3 Out_Normal84 = lerpResult53;
				
				float2 temp_cast_1 = (_Noise1).xx;
				float2 texCoord10 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float simplePerlin2D7 = snoise( texCoord10 );
				float2 temp_cast_2 = (( _Noise1 * _Noise2 )).xx;
				float2 texCoord13 = packedInput.ase_texcoord3.xy * temp_cast_2 + float2( 0,0 );
				float simplePerlin2D12 = snoise( texCoord13 );
				float2 uv_Noise_Texture = packedInput.ase_texcoord3.xy * _Noise_Texture_ST.xy + _Noise_Texture_ST.zw;
				float4 clampResult126 = clamp( ( ( ( 1.0 - ( simplePerlin2D7 * simplePerlin2D12 * tex2D( _Noise_Texture, uv_Noise_Texture ) ) ) + _Bias ) * _Scale ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_cast_3 = (( 3.0 * _Bias )).xxxx;
				float temp_output_2_0_g2 = _DriedBloodEffectLevel;
				float temp_output_3_0_g2 = ( 1.0 - temp_output_2_0_g2 );
				float3 appendResult7_g2 = (float3(temp_output_3_0_g2 , temp_output_3_0_g2 , temp_output_3_0_g2));
				float3 temp_output_67_0 = ( ( pow( clampResult126 , temp_cast_3 ).rgb * temp_output_2_0_g2 ) + appendResult7_g2 );
				float3 clampResult59 = clamp( temp_output_67_0 , float3( 0,0,0 ) , float3( 1,1,1 ) );
				float3 temp_output_60_0 = ( clampResult59 * _DriedBloodEffectLevel );
				float lerpResult46 = lerp( _Gloss , _DriedBloodColorGloss.a , temp_output_60_0.x);
				float Out_Smoothness80 = lerpResult46;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_Noise1).xx;
				float2 texCoord10 = packedInput.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float simplePerlin2D7 = snoise( texCoord10 );
				float2 temp_cast_1 = (( _Noise1 * _Noise2 )).xx;
				float2 texCoord13 = packedInput.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				float simplePerlin2D12 = snoise( texCoord13 );
				float2 uv_Noise_Texture = packedInput.ase_texcoord7.xy * _Noise_Texture_ST.xy + _Noise_Texture_ST.zw;
				float4 clampResult126 = clamp( ( ( ( 1.0 - ( simplePerlin2D7 * simplePerlin2D12 * tex2D( _Noise_Texture, uv_Noise_Texture ) ) ) + _Bias ) * _Scale ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 temp_cast_2 = (( 3.0 * _Bias )).xxxx;
				float temp_output_2_0_g2 = _DriedBloodEffectLevel;
				float temp_output_3_0_g2 = ( 1.0 - temp_output_2_0_g2 );
				...
				float4 blendOpDest24 = ( _MainColorTintFadeA * tex2DNode1.r );
				float2 temp_cast_5 = (_DriedBloodEffect_Tiling).xx;
				float2 texCoord38 = packedInput.ase_texcoord7.xy * temp_cast_5 + float2( 0,0 );
				float4 blendOpSrc36 = _DriedBloodColorGloss;
				float4 blendOpDest36 = tex2D( _DriedBlood_Curvature, texCoord38 );
				float3 temp_output_60_0 = ( clampResult59 * _DriedBloodEffectLevel );
				float4 lerpResult34 = lerp( ( saturate( (( blendOpDest24 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest24 ) * ( 1.0 - blendOpSrc24 ) ) : ( 2.0 * blendOpDest24 * blendOpSrc24 ) ) )) , (( blendOpDest36 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest36 ) * ( 1.0 - blendOpSrc36 ) ) : ( 2.0 * blendOpDest36 * blendOpSrc36 ) ) , float4( temp_output_60_0 , 0.0 ));
				...
				float2 uv_MainNormalMap = packedInput.ase_texcoord7.xy * _MainNormalMap_ST.xy + _MainNormalMap_ST.zw;
				float3 lerpResult45 = lerp( UnpackNormalScale( tex2D( _MainNormalMap, uv_MainNormalMap ), 1.0f ) , UnpackNormalScale( tex2D( _DriedBlood_Normal, texCoord38 ), 1.0f ) , _DriedBloodEffectLevel);
				float3 lerpResult53 = lerp( float3(0,0,1) , lerpResult45 , _OverallNormalPower);
				float3 Out_Normal84 = lerpResult53;
...
/*ASEBEGIN
Version=18801
1920;54;1920;975;2086.436;1129.244;1.732815;True;False
...
Node;AmplifyShaderEditor.FunctionNode;19;-59.50874,-565.6967;Inherit;False;ConstantBiasScale;-1;;1;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;COLOR;0,0,0,0;False;1;FLOAT;0.1;False;2;FLOAT;1.25;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;126;168.4611,-547.3459;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;127;-538.1084,-135.6887;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-13.69085,-122.3695;Float;False;Property;_DriedBloodEffectLevel;DriedBloodEffectLevel;10;0;Create;True;0;0;0;False;0;False;0.5;0.089;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-753.1951,21.89014;Float;False;Property;_TrasparencyPower;TrasparencyPower;1;0;Create;True;0;0;0;False;0;False;0.6;0.385;0.1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;55;255.7104,-665.3391;Inherit;False;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;3;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;334.0267,-365.0195;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClampOpNode;125;467.4316,-375.8265;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,1,1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-801.1509,332.2745;Float;False;Property;_DriedBloodEffect_Tiling;DriedBloodEffect_Tiling;14;0;Create;True;0;0;0;False;0;False;0;395;0;1000;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;-355.3676,-392.0108;Float;False;Property;_MainColorTintFadeA;MainColorTint-Fade(A);2;0;Create;True;0;0;0;False;0;False;0.9558824,0.9277682,0.9277682,1;0.4191174,0.1047792,0.1047792,0.6745098;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;59;523.785,-684.8718;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,1,1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;35;89.04,25.6489;Float;False;Property;_DriedBloodColorGloss;DriedBloodColor-Gloss;13;0;Create;True;0;0;0;False;0;False;0.083045,0.08415466,0.08823532,0;0.1617646,0.08629627,0.05233558,0.153;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;64;1788.009,352.2007;Float;False;Property;_DriedOpacityLevel;DriedOpacityLevel;16;0;Create;True;0;0;0;False;0;False;0;2.11;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;29;1196.652,-293.1428;Float;False;Property;_Metallic;Metallic;4;0;Create;True;0;0;0;False;0;False;0.25;0.198;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;1789.844,170.389;Float;False;Property;_OverallNormalPower;OverallNormalPower;17;0;Create;True;0;0;0;False;0;False;0.8;1.46;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;1431.811,-235.9101;Float;False;Property;_DriedBlood_Metallic;DriedBlood_Metallic;15;0;Create;True;0;0;0;False;0;False;0.5;0.057;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;79;2882.51,-23.79568;Inherit;False;78;Out_Opacity;1;0;OBJECT;;False;1;FLOAT3;0
...
WireConnection;126;0;19;0
WireConnection;127;0;1;4
WireConnection;55;0;126;0
...
WireConnection;114;4;86;0
WireConnection;114;7;87;0
WireConnection;114;9;79;0
WireConnection;114;10;77;0
ASEEND*/
//CHKSM=7EBA9CE43CF6E9532A853D2AC82792D1391CFF7F