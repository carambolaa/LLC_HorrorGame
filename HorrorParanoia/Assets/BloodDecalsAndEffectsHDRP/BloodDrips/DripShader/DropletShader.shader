...
Shader "Blood/DropletShader"
{
	Properties
	{
		...
		[ASEEnd]_NormalMapPower("NormalMapPower", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_AlbedoAlpha = packedInput.ase_texcoord5.xy * _AlbedoAlpha_ST.xy + _AlbedoAlpha_ST.zw;
				float4 temp_output_4_0 = ( _Color_GlossA * tex2D( _AlbedoAlpha, uv_AlbedoAlpha ) );
				
				float2 uv_NormalMap = packedInput.ase_texcoord5.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float3 lerpResult7 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f ) , _NormalMapPower);
				
				surfaceDescription.Albedo = temp_output_4_0.rgb;
				surfaceDescription.Normal = lerpResult7;
				...
				surfaceDescription.Emission = ( temp_output_4_0 * _EmissiveAmount ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoAlpha = packedInput.ase_texcoord.xy * _AlbedoAlpha_ST.xy + _AlbedoAlpha_ST.zw;
				float4 temp_output_4_0 = ( _Color_GlossA * tex2D( _AlbedoAlpha, uv_AlbedoAlpha ) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoAlpha = packedInput.ase_texcoord7.xy * _AlbedoAlpha_ST.xy + _AlbedoAlpha_ST.zw;
				float4 temp_output_4_0 = ( _Color_GlossA * tex2D( _AlbedoAlpha, uv_AlbedoAlpha ) );
...
WireConnection;27;4;17;0
WireConnection;27;6;10;0
ASEEND*/
//CHKSM=4F0AE347C9A63AB85EAC9AF25D7C0B13287F0565